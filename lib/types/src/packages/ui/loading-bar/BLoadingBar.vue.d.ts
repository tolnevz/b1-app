...
import type { TClasses, TComponentVariantType } from '../../types';
declare const _default: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    type: {
        type: PropType<ILoadingBarAttributes["type"]>;
        default: TComponentVariantType | undefined;
    };
}>, {}, {
    cssClass: string;
    stateType: TComponentVariantType | undefined;
}, {
    classes(): TClasses;
    progressClasses(): TClasses;
    ...
    type: TComponentVariantType | undefined;
