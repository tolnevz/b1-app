...
import { type IControlValueAttributes } from '../control-value';
import type { ICollectionAttributes } from './types.d';
declare const _default: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    items: {
        type: PropType<ICollectionAttributes<any>["items"]>;
        default: unknown[];
    };
    selected: {
        type: PropType<ICollectionAttributes<any>["selected"]>;
        default: unknown;
    };
}>, {}, {
    cssClass: string;
    ...
    value: {
        type: PropType<IControlValueAttributes["value"]>;
        default: any;
    };
