...
import type { ITagAttributes } from './types';
import { type TClasses } from '../../types';
declare const _default: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    type: {
        type: PropType<ITagAttributes["type"]>;
        default: import("../../types").TComponentVariantType | undefined;
    };
    sizeControl: {
        type: PropType<ITagAttributes["sizeControl"]>;
        default: import("../../types").TSizeControl | undefined;
    };
    asLabel: {
        type: PropType<ITagAttributes["asLabel"]>;
        default: boolean | undefined;
    };
    outlined: {
        type: PropType<ITagAttributes["outlined"]>;
        default: boolean | undefined;
    };
    plain: {
        type: PropType<ITagAttributes["plain"]>;
        default: boolean | undefined;
    };
    simple: {
        type: PropType<ITagAttributes["simple"]>;
        default: boolean | undefined;
    };
    loading: {
        type: PropType<ITagAttributes["loading"]>;
        default: boolean | import("../../types").ILoading | undefined;
    };
    onPropClick: {
        type: PropType<ITagAttributes["onPropClick"]>;
