...
import type { IBodyCellAttributes } from './types';
import type { TClasses } from '../../../types';
declare const _default: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    field: {
        type: PropType<IBodyCellAttributes["field"]>;
        default: string;
    };
    value: {
        type: PropType<IBodyCellAttributes["value"]>;
        default: any;
    };
    selection: {
        type: PropType<IBodyCellAttributes["selection"]>;
