...
import type { IFooterAttributes } from './types';
declare const _default: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    columns: {
        type: PropType<IFooterAttributes["columns"]>;
        default: import("../index.ts").IColumnAttributes[];
    };
    rows: {
        type: PropType<IFooterAttributes["rows"]>;
        default: Record<string, any>[];
    };
    showSelection: {
        type: PropType<IFooterAttributes["showSelection"]>;
