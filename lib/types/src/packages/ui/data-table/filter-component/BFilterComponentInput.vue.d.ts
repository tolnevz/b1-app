import { ESizeControl, type ISimpleItem } from '../../../types';
import type { IFilterComponentAttributes } from './types';
declare const _default: import("vue").DefineComponent<{}, {}, {}, {}, {
    onChange(data: ISimpleItem): void;
    onClear(): void;
    onKeyDown(event: KeyboardEvent): void;
}, import("vue").ComponentOptionsMixin, import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    field: {
        type: import("vue").PropType<IFilterComponentAttributes["field"]>;
        default: string | undefined;
    };
    operation: {
        type: import("vue").PropType<IFilterComponentAttributes["operation"]>;
        default: any;
    };
    operations: {
        type: import("vue").PropType<IFilterComponentAttributes["operations"]>;
        default: any[] | undefined;
    };
    value: {
        type: import("vue").PropType<IFilterComponentAttributes["value"]>;
        default: any;
    };
    showOperation: {
        type: import("vue").PropType<IFilterComponentAttributes["showOperation"]>;
    ...
    BInput: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
        placeholder: {
            type: import("vue").PropType<import("../../input").IInputAttributes["placeholder"]>;
            default: string | undefined;
        };
        type: {
            type: import("vue").PropType<import("../../input").IInputAttributes["type"]>;
            default: any;
        };
        pattern: {
            type: import("vue").PropType<import("../../input").IInputAttributes["pattern"]>;
            default: string | undefined;
        };
        required: {
            type: import("vue").PropType<import("../../input").IInputAttributes["required"]>;
            default: boolean | undefined;
        };
        autocomplete: {
            type: import("vue").PropType<import("../../input").IInputAttributes["autocomplete"]>;
            default: string | undefined;
        };
        maxlength: {
            type: import("vue").PropType<import("../../input").IInputAttributes["maxlength"]>;
            default: number | undefined;
        };
        minlength: {
            type: import("vue").PropType<import("../../input").IInputAttributes["minlength"]>;
            default: number | undefined;
        };
        visibility: {
            type: import("vue").PropType<import("../../input").IInputAttributes["visibility"]>;
            default: boolean | undefined;
        };
        clearButton: {
            type: import("vue").PropType<import("../../input").IInputAttributes["clearButton"]>;
            default: boolean | undefined;
        };
        clearWithText: {
            type: import("vue").PropType<import("../../input").IInputAttributes["clearWithText"]>;
            default: boolean | undefined;
        };
        showStateIcon: {
            type: import("vue").PropType<import("../../input").IInputAttributes["showStateIcon"]>;
            default: boolean | undefined;
        };
        sizeControl: {
            type: import("vue").PropType<import("../../input").IInputAttributes["sizeControl"]>;
            default: import("../../../types").TSizeControl | undefined;
        };
        loading: {
            type: import("vue").PropType<import("../../input").IInputAttributes["loading"]>;
            default: boolean | import("../../../types").ILoading | undefined;
        };
        simple: {
            type: import("vue").PropType<import("../../input").IInputAttributes["simple"]>;
            default: boolean | undefined;
        };
        asSelect: {
            type: import("vue").PropType<import("../../input").IInputAttributes["asSelect"]>;
            default: boolean | undefined;
        };
    }>, {}, {
        cssClass: string;
